...
//   // Function to decide badge color based on score
...
//       <div className="bg-white rounded-2xl shadow-2xl w-11/12 max-w-6xl p-6 relative animate-fadeIn">
//         {/* Close Button */}
//         <button
//           onClick={onClose}
...
//           {/* Before */}
//           <div className="border rounded-xl p-5 flex flex-col items-center shadow-md bg-gray-50">
//             <span className="bg-red-500 text-white text-sm font-semibold px-4 py-1 rounded-full uppercase mb-4">
//               Before
//             </span>
//             <div className="relative w-full max-h-[450px] overflow-y-auto"
//               style={{scrollbarWidth:"thin"}}
//             >
//               <img
//                 src={`https://api.inspireambitions.com${beforeData?.imageUrl}`}
//                 alt="Before Resume"
//                 width={800} // give width and height instead of fill
//                 height={1200}
...
//             {/* Score */}
//             <div
//               className={`mt-5 px-6 py-2 rounded-full flex flex-col items-center ring-2 ${beforeStyles.bg} ${beforeStyles.text} ${beforeStyles.ring}`}
//             >
//               <span className="text-2xl font-bold">{beforeData?.score}</span>
//               <span className="text-sm font-medium">{beforeStyles.label}</span>
...
//             >
//               <img
//                 src={`https://api.inspireambitions.com${afterData?.imageUrl}`}
//                 alt="After Resume"
//                 width={800}
//                 height={1200}
//                 className="rounded-lg object-cover"
...
//             {/* Score */}
//             <div
//               className={`mt-5 px-6 py-2 rounded-full flex flex-col items-center ring-2 ${afterStyles.bg} ${afterStyles.text} ${afterStyles.ring}`}
//             >

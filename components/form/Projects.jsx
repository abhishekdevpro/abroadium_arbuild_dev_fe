              ...
              <>
                    ...
                    <div className="absolute z-50 right-0 top-[50px] w-80 bg-white rounded-lg shadow-xl transform transition-all duration-200 ease-in-out border border-gray-700">
                      <div className="p-4 border-b border-gray-700">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                            <AlertCircle className="w-5 h-5 text-red-400" />
                            <span className="font-medium text-black">Key Achievements Suggestions</span>
                          </div>
                      ...
                      <div className="p-4">
                        {getErrorMessages(projectIndex, "keyAchievements").map((msg, i) => (
                ...
                {/* <div className="">
                  ...
                  <div className="flex-wrap-gap-2">
                    ...
                    {activeTooltip === `startYear-${projectIndex}` && (
                      <div className="absolute z-50 right-0 mt-14 w-80 bg-white rounded-lg shadow-xl border border-gray-700">
                        <div className="p-4 border-b border-gray-700">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-2">
                              <AlertCircle className="w-5 h-5 text-red-400" />
...
//   const handleKeyAchievement = (value, projectIndex) => {
//     const newProjects = [...resumeData.projects]
//     // Handle both string and array formats
//     let achievements
//     if (typeof value === "string") {
//       // Clean HTML tags and split by newlines
//       achievements = value
//         .replace(/<[^>]*>/g, "")
//         .split("\n")
//         .filter((item) => item.trim())
...
//       return
//     }
//     if (!resumeData.projects[index].startYear || !resumeData.projects[index].endYear) {
//       toast.warn("Date is Required")
//       return
//     }
//     console.log("called");
...
//     } else {
//       newProjects[index].keyAchievements = selectedKeyAchievements
//       console.log(selectedKeyAchievements,"selectedKeyAchievements");
//     }
...
//       const response = await fetch("https://api.abroadium.com/api/jobseeker/ai-prosummery", {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//           Authorization: `${token}`,
...
//           ...prev,
//           projects: prev.projects.map((proj, i) =>
//             i === projectIndex ? { ...proj, description: updatedDescription } : proj,
//           ),
//         }))
...
//       }
//     } catch (error) {
//       console.error(`Error auto-fixing project description at index ${projectIndex}:`, error)
//       console.log(resumeData.position, ">>>>>position")
//       toast.error("An error occurred while processing your request")
//     } finally {
//       setLoadingStates((prev) => ({
...
//       return
//     }
//     if (!resumeData.projects[projectIndex].startYear || !resumeData.projects[projectIndex].endYear) {
//       toast.warn("Date is Required")
//       return
//     }
//     setLoadingStates((prev) => ({
...
//                     name="name"
//                     className={`w-full other-input border  ${
//                       improve && hasErrors(projectIndex, "name") ? "border-red-500" : "border-black"
//                     }`}
//                     value={project.name}
//                     onChange={(e) => handleProjects(e, projectIndex)}
//                   />
...
//                       className="absolute right-2 top-1/2 -translate-y-1/2 text-red-500 hover:text-red-600 transition-colors"
//                       onClick={() =>
//                         setActiveTooltip(activeTooltip === `name-${projectIndex}` ? null : `name-${projectIndex}`)
//                       }
//                     >
//                       <AlertCircle className="w-5 h-5" />
//                     </button>
...
//                           <div className="flex items-center space-x-2">
//                             <AlertCircle className="w-5 h-5 text-red-400" />
//                             <span className="font-medium text-black">Project Name Suggestion</span>
//                           </div>
//                           <button onClick={() => setActiveTooltip(null)} className="text-black transition-colors">
//                             <X className="w-5 h-5" />
//                           </button>
...
//                       </div>
//                       <div className="p-4">
//                         {getErrorMessages(projectIndex, "name").map((msg, i) => (
//                           <div key={i} className="flex items-start space-x-3 mb-3 last:mb-0">
//                             <div className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-red-400 mt-2"></div>
//                             <p className="text-black text-sm">{msg}</p>
//                           </div>
...
//                       name="link"
//                       className={`w-full other-input border  ${
//                         improve && hasErrors(projectIndex, "link") ? "border-red-500" : "border-black"
//                       }`}
//                       value={project.link}
//                       onChange={(e) => handleProjects(e, projectIndex)}
//                     />
...
//                         className="absolute right-2 top-1/2 -translate-y-1/2 text-red-500 hover:text-red-600 transition-colors"
//                         onClick={() =>
//                           setActiveTooltip(activeTooltip === `link-${projectIndex}` ? null : `link-${projectIndex}`)
//                         }
//                       >
//                         <AlertCircle className="w-5 h-5" />
//                       </button>
...
//                         </div>
//                         <div className="p-4">
//                           {getErrorMessages(projectIndex, "link").map((msg, i) => (
//                             <div key={i} className="flex items-start space-x-3 mb-3 last:mb-0">
//                               <div className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-red-400 mt-2"></div>
//                               <p className="text-black text-sm">{msg}</p>
//                             </div>
...
//                       <select
//                         className={`other-input border flex-1 ${
//                           improve && hasErrors(projectIndex, "startYear") ? "border-red-500" : "border-black"
//                         }`}
//                         value={(project.startYear || "Jan,2024").split(",")[0]}
//                         onChange={(e) => handleMonthChange(e, projectIndex, "startYear")}
//                       >
//                         {months.map((month, idx) => (
//                           <option key={idx} value={month}>
//                             {month}
...
//                         onChange={(e) => handleYearChange(e, projectIndex, "startYear")}
//                       >
//                         {years.map((year, idx) => (
//                           <option key={idx} value={year}>
//                             {year}
...
//                           onClick={() =>
//                             setActiveTooltip(
//                               activeTooltip === `startYear-${projectIndex}` ? null : `startYear-${projectIndex}`,
//                             )
//                           }
//                         >
//                           <AlertCircle className="w-5 h-5" />
...
//                         </div>
//                         <div className="p-4">
//                           {getErrorMessages(projectIndex, "startYear").map((msg, i) => (
//                             <div key={i} className="flex items-start space-x-3 mb-3 last:mb-0">
//                               <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-2" />
//                               <p className="text-black text-sm">{msg}</p>
//                             </div>
...
//                       <select
//                         className={`other-input border flex-1 ${
//                           improve && hasErrors(projectIndex, "endYear") ? "border-red-500" : "border-black"
//                         }`}
//                         value={project.endYear === "Present" ? "" : (project.endYear || "Dec,2024").split(",")[0]}
//                         onChange={(e) => handleMonthChange(e, projectIndex, "endYear")}
//                         disabled={project.endYear === "Present"}
//                       >
//                         {months.map((month, idx) => (
//                           <option key={idx} value={month}>
...
//                           improve && hasErrors(projectIndex, "endYear") ? "border-red-500" : "border-black"
//                         }`}
//                         value={project.endYear === "Present" ? "" : (project.endYear || "Dec,2024").split(",")[1]}
//                         onChange={(e) => handleYearChange(e, projectIndex, "endYear")}
//                         disabled={project.endYear === "Present"}
//                       >
//                         {years.map((year, idx) => (
//                           <option key={idx} value={year}>
...
//                           onClick={() =>
//                             setActiveTooltip(
//                               activeTooltip === `endYear-${projectIndex}` ? null : `endYear-${projectIndex}`,
//                             )
//                           }
//                         >
//                           <AlertCircle className="w-5 h-5" />
...
//                         </div>
//                         <div className="p-4">
//                           {getErrorMessages(projectIndex, "endYear").map((msg, i) => (
//                             <div key={i} className="flex items-start space-x-3 mb-3 last:mb-0">
//                               <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-2" />
//                               <p className="text-black text-sm">{msg}</p>
//                             </div>
...
//                     }
//                     className={`bg-white rounded-md ${
//                       improve && hasErrors(projectIndex, "description") ? "border-red-500" : "border-black"
//                     }`}
//                     theme="snow"
//                     modules={{
//                       toolbar: [["bold", "italic", "underline"], ["clean"]],
...
//                       onClick={() =>
//                         setActiveTooltip(
//                           activeTooltip === `description-${projectIndex}` ? null : `description-${projectIndex}`,
//                         )
//                       }
//                     >
//                       <AlertCircle className="w-5 h-5" />
...
//                           <button
//                             type="button" // Prevent form submission if inside a form
//                             onClick={(e) => handleAutoFixDescription(e, projectIndex, project)}
//                             onMouseDown={() => {
//                               if (!project?.name) {
//                                 toast.error("Title is required")
//                               }
//                             }}
//                             className="px-3 py-1 text-sm font-medium text-white bg-blue-600 rounded-md shadow hover:bg-blue-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
//                             disabled={loadingStates[`description_${projectIndex}`] || !project?.name}
//                           >
//                             {loadingStates[`description_${projectIndex}`] ? "Fixing..." : "Auto Fix"}
//                           </button>
...
//                       </div>
//                       <div className="p-4">
//                         {getErrorMessages(projectIndex, "description").map((msg, i) => (
//                           <div key={i} className="flex items-start space-x-3 mb-3 last:mb-0">
//                             <div className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-red-400 mt-2"></div>
//                             <p className="text-black text-sm">{msg}</p>
//                           </div>
...
//                     }}
//                     className={`bg-white rounded-md ${
//                       improve && hasErrors(projectIndex, "keyAchievements") ? "border-red-500" : "border-black"
//                     }`}
//                     theme="snow"
//                     modules={{
//                       toolbar: [["bold", "italic", "underline", "list"], ["clean"]],
//                     }}
//                   />
...
//         ))
//       ) : (
//         <p className="text-white my-2">No projects available. Add a new project to get started.</p>
//       )}
//       {/* <button onClick={addProjects} className="bg-blue-500 text-white px-4 py-2 rounded mt-4" type="button">
//         Add Project
//       </button> */}
...
//                 <div className="text-center py-2">
//                   <p className="text-gray-500">
//                     {popupType === "description" ? "No descriptions available. " : "No key achievements available. "}
//                   </p>
//                 </div>
//               )}
//             </div>

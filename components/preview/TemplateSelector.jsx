...
//                 className="absolute left-0 z-10 top-1/2 -translate-y-1/2 bg-white border shadow-lg rounded-full w-10 h-10 flex items-center justify-center hover:bg-gray-100"
//               >
//                 <ChevronLeft />
//               </button>
...
//               <div
//                 ref={scrollRef}
//                 className="flex gap-4 overflow-x-auto scroll-smooth px-12 py-4 scrollbar-hide"
//               >
//                 {templates.map((template) => (
//                   <div
//                     key={template.key}
//                     onClick={() => handleTemplateClick(template)}
//                     className={`cursor-pointer flex-shrink-0 w-56 transition-transform duration-200
//           ${template.key === templateId ? "scale-105" : "hover:scale-105"}
//         `}
//                   >
//                     <div
...
//                 className="absolute right-0 z-10 top-1/2 -translate-y-1/2 bg-white border shadow-lg rounded-full w-10 h-10 flex items-center justify-center hover:bg-gray-100"
//               >
//                 <ChevronRight />
//               </button>
//             </div>
...
//             <button
//               onClick={closeModal}
//               className="w-full sm:w-auto px-6 py-2.5 bg-[#002a48] text-white font-semibold rounded-lg hover:bg-gray-700 transition-colors duration-200 flex items-center justify-center mx-auto"
//             >
//               Close
//             </button>
//           </div>

...
export const createResume = async (selectedLang = "en") => {
  try {
    ...
    const response = await axios.post(
      `https://api.abroadium.com/api/jobseeker/resume-create?lang=${selectedLang}`,
      {},
      {
        headers: {
...
export const CreateCV = async () => {
  try {
    ...
    const response = await axios.post(
      `https://api.abroadium.com/api/jobseeker/coverletter?lang=${selectedLang}`,
      {},
      {
        headers: {
          Authorization: ` ${token}`,
...
export const getResumes = async (lang) => {
  return axios.get(
    `https://api.abroadium.com/api/jobseeker/resume-list?lang=${lang}`,
    {
...
export const deleteResume = async (id, lang) => {
  return axios.delete(
    `https://api.abroadium.com/api/jobseeker/resume-list/${id}?lang=${lang}`,
    {
      headers: { Authorization: token() },
    }
  );
...
export const updateResumeTitle = async (id, newTitle) => {
  return axios.put(
    `https://api.abroadium.com/api/jobseeker/resume-details/${id}`,
...
export const duplicateResume = async (id) => {
  return axios.post(
    `https://api.abroadium.com/api/jobseeker/resumes/${id}/duplicate`,
    {},
    { headers: { Authorization: token() } }
  );
};

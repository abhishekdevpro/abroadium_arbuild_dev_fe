        ...
        <div className="max-w-5xl w-full bg-white shadow-lg rounded-xl p-6 md:flex">
          ...
          <div className="w-full bg-gray-100 p-6 rounded-xl mt-6 md:mt-0">
            ...
            <Button
              ...
              disabled={loading}
              className={`w-full mt-6 bg-purple-600 hover:bg-purple-700 text-white py-4 px-4 rounded-lg font-medium transition duration-200 flex items-center justify-center ${
                loading ? "opacity-75" : ""
              }`}
            >
              {loading ? (
